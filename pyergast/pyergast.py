...
def get_drivers(year=None, race=None):
    ...
    """
    if year and race:
        url = 'https://ergast.com/api/f1/{}/drivers.json?limit=1000'.format(year, race)
    elif year:
        url = 'https://ergast.com/api/f1/{}/drivers.json?limit=1000'.format(year, race)
    else:
...
def get_constructors(year=None, race=None):
    ...
    """
    if year and race:
        url = 'https://ergast.com/api/f1/{}/constructors.json?limit=1000'.format(year, race)
    elif year:
        url = 'https://ergast.com/api/f1/{}/constructors.json?limit=1000'.format(year, race)
    else:
        url = 'https://ergast.com/api/f1/constructors.json?limit=1000'
...
def get_circuits(year=None, race=None):
    ...
    """
    if year and race:
        url = 'https://ergast.com/api/f1/{}/circuits.json?limit=1000'.format(year, race)
    elif year:
        url = 'https://ergast.com/api/f1/{}/circuits.json?limit=1000'.format(year, race)
    else:
        url = 'https://ergast.com/api/f1/circuits.json?limit=1000'
...
def get_race_result(year=None, race=None):
    ...
    if year or race:
        ...
        url = 'https://ergast.com/api/f1/{}/{}/results.json?limit=1000'.format(year, race)
    else:
        url = 'https://ergast.com/api/f1/current/last/results.json?limit=1000'
...
def get_qualifying_result(year=None, race=None):
    ...
    if year and race:
        ...
        url = 'https://ergast.com/api/f1/{}/{}/qualifying.json?limit=1000'.format(year, race)
    else:
        url = 'https://ergast.com/api/f1/current/last/qualifying.json?limit=1000'
...
def get_schedule(year=None):
    ...
    """
    if year:
        url = 'https://ergast.com/api/f1/{}.json?limit=1000'.format(year)
    else:
...
def driver_standings(year=None, race=None):
    ...
    """
    if year and race:
        url = 'https://ergast.com/api/f1/{}/{}/driverStandings.json?limit=1000'.format(year, race)
    elif year:
        url = 'https://ergast.com/api/f1/{}/driverStandings.json?limit=1000'.format(year, race)
    else:
        url = 'https://ergast.com/api/f1/current/driverStandings.json?limit=1000'
...
def constructor_standings(year=None, race=None):
    ...
    if year and race:
        ...
        url = 'https://ergast.com/api/f1/{}/{}/constructorStandings.json?limit=1000'.format(year, race)
    elif year:
        assert year >= 1958, 'Constructor standings only available starting 1958'
        url = 'https://ergast.com/api/f1/{}/constructorStandings.json?limit=1000'.format(year, race)
    else:
        url = 'https://ergast.com/api/f1/current/constructorStandings.json?limit=1000'
...
def query_driver(driverid):
    ...
    """
    url = 'https://ergast.com/api/f1/drivers/{}/driverStandings.json?limit=1000'.format(driverid)
    r = requests.get(url)
    assert r.status_code == 200, 'Cannot connect to Ergast API. Check your inputs.'
...
def query_constructor(constructorid):
    ...
    """
    url = 'https://ergast.com/api/f1/constructors/{}/constructorStandings.json?limit=1000'.format(constructorid)
    r = requests.get(url)
    assert r.status_code == 200, 'Cannot connect to Ergast API. Check your inputs.'
    seasons = r.json()['MRData']['StandingsTable']['StandingsLists']
